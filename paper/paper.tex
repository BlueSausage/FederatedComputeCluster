...
Nur als Ausblick (nicht als Kritik):
\begin{itemize}
    \item Selbstverarbeitung leicht bestrafen
    \item Kosten persistent machen (nicht jede Runde neu)
    \item Jobs knapper machen
    \item Bieten verpflichtend (kein Opt-out)
    \item Preis träger oder exogen
\end{itemize}
\dots
