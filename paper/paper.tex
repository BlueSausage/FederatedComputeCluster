...
Statische Preisgestaltung ergänzen\dots
\newline
\newline
...
\begin{table}[]
    ...
    \end{tabular}
    \caption{Statistische Kennzahlen der durchschnittlichen Rewards je Agent im statischen Szenario.}
...
\begin{table}[]
    ...
    \end{tabular}
    \caption{Statistische Kennzahlen der durchschnittlichen Rewards je Agent im dynamischen Szenario.}
