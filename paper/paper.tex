...
\newline
Dieses einfache, nicht-kooperative Marktverfahren erschafft einen Auktionsmechanismus mit begrenztem Wettbewerb und Unsicherheit, der es den Agenten erlaubt, durch wiederholte Teilnahme und Lernen über Q-Learning geeignete Strategien zu entwickeln.
...
\newline
Nicht erfolgreiche Aktionen (z.B. kein Zuschlag bei Geboten oder keine Abnahme des angebotenen Auftrages) führen zu einer Belohnung wie bei der Selbstbearbeitung.
\newline
\newline
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/q_table_rz1.png}
        \caption{RZ1}
        \label{fig:q_table_rz1}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/q_table_rz2.png}
        \caption{RZ2}
        \label{fig:q_table_rz2}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/q_table_rz3.png}
        \caption{RZ3}
        \label{fig:q_table_rz3}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/q_table_rz4.png}
        \caption{RZ4}
        \label{fig:q_table_rz4}
    \end{subfigure}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/q_table_rz5.png}
        \caption{RZ5}
        \label{fig:q_table_rz5}
    \end{subfigure}

    \caption{Q-Tabellen (Heatmaps) für RZ1-RZ5.}
    \label{fig:q_table_rz}
\end{figure}
\newline
Ein zentrales Element dieser Analyse sind die Q-Tabellen aller fünf Agenten (siehe Abbildung \ref{fig:q_table_rz}), welche deren final erlernte Strategien nach 8000 Runden darstellen. Trotz individueller Unterschiede zeigt sich ein einheitliches Muster. In Zuständen mit Verlusten bevorzugen alle Agenten die Aktion „Job inserieren“, unabhängig vom vorherigen Marktdruck. Diese Entscheidung entspricht der ökonomischen Intuition, da ein Verkauf am Markt Verluste aus der Selbstbearbeitung vermeiden kann.
\begin{figure}[!b]
    ...
    \end{subfigure}
    \caption{Lernverhalten der Agenten im dynamischen Szenario.}
\end{figure}
\newline
Bei profitablen Zuständen fällt die Wahl der besten Aktion differenzierter aus. Einige Agenten (z.B. RZ2, RZ3) entscheiden sich häufiger für das Bieten mit moderaten Faktoren (z.B. 0.5), andere (z.B. RZ4, RZ5) zeigen eine stärkere Präferenz für die Selbstbearbeitung. Diese Vielfalt spricht dafür, dass sich individuelle Lernverläufe ausgebildet haben, die auf den jeweiligen Erfahrungen beruhen.
\newline
Tabelle \ref{tab:dynamic_costs} fasst die statistischen Kennzahlen der durchschnittlichen Rewards im dynamischen Szenario zusammen. Alle Agenten erreichen ähnliche Mittelwerte und vergleichbare Streuungen, was auf eine faire Ergebnisverteilung trotz individueller Strategien hinweist. Das Verhältnis $\frac{\sigma}{\mu}$ liegt für alle Agenten nahe bei 1, was ebenfalls für eine stabile Lernumgebung spricht.
\newline
Die Entwicklung der Q-Werte über die Zeit wird in Abbildung \ref{fig:q_table_convergence} dargestellt. Hier zeigt sich, dass sich die Q-Werte aller Agenten im Laufe der Simulation deutlich stabilisieren. Bereits nach etwa 3000 Runden geht die durchschnittliche Änderung der Q-Tabelle deutlich zurück und pendelt sich auf einem niedrigen Niveau ein. Dies deutet auf eine Konvergenz der individuellen Lernprozesse hin, d.h. die Agenten haben stabile Strategien ausgebildet.
Auch die Entwicklung des Social Welfare über die Zeit bestätigt diesen Trend (siehe Abbildung \ref{fig:social_welfare}).
\newpage
Nach anfänglichen Schwankungen steigt der durchschnittliche Gesamtertrag des Systems kontinuierlich an und erreicht ab Runde 3000 ein weitgehend stabiles Niveau. Dies legt nahe, dass nicht nur individuelle Agenten voneinander lernen, sondern dass sich auch das Zusammenspiel im Markt verbessert.
\newline
...
\begin{figure}[!htb]
    ...
    \end{subfigure}
    \caption{Analyse der Auftragsverteilung.}
\end{figure}
